            ...
            <div className="container mx-auto px-6 py-24 max-w-7xl">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
                    ...
                    >
                        ...
                        {status.message && (
                            <div className={`p-4 mb-6 rounded-lg ${status.type === 'success' ? 'bg-sansRed text-sansRed' : 'bg-red-50 text-red-800'}`}>
                                {status.message}
                            </div>
                        )}
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            */}
                            ...
                            <button
                                ...
                                className="w-full py-4 bg-sansGray text-white font-medium text-lg rounded-lg shadow-lg hover:bg-sansRed hover:shadow-xl transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
                            >
